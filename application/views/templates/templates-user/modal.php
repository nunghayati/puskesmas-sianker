      ...
      <div class="modal-content">
         ...
         <form action="<?= base_url('member/daftar'); ?>" method="POST">
            <div class="modal-body">
               ...
               <div class="form-group">
                  <input type="date" class="form-control form-control-user" name="ttl" id="ttl" placeholder="Tanggal lahir">
               </div>
               <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?= base_url('member/logout'); ?>" class="btn btn-info">Log out</a>
      </div>
    </div>
  </div>
</div>