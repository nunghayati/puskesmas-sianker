	...
	<nav class="navbar navbar-default">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url().'admin'; ?>">Puskesmas</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li><a href="<?php echo base_url().'buku'; ?>"><span class="glyphicon glyphicon-folder-open"></span> Data Poli</a></li>
					<li><a href="<?php echo base_url().'anggota'; ?>"><span class="glyphicon glyphicon-user"></span> Data Pasien</a></li>
					<li><a href="<?php echo base_url().'peminjaman'; ?>"><span class="glyphicon glyphicon-sort"></span> Booking Pendaftaran</a></li>
